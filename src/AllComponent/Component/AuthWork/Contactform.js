            ...
            <div className="col-lg-4 col-md-5 mbile_res_contact_block">
              <div className="Contact_icon_block">
                <div className="Contact_icon">
                  <img className="web_res_icon" src={Adress} />{" "}
                  <img className="mobile_res_icon" src={MobileAdress} />
                </div>
                <div>
                  <div className="Contact_icon_heading">Address</div>
              ...
              <div className="Contact_icon_block">
                <div className="Contact_icon">
                  <img className="web_res_icon" src={Email} />{" "}
                  <img className="mobile_res_icon" src={MobilePhone} />
                </div>
                <div>
                  <a
                    href="mailto:abhishekgoyal3669@gmail.com"
                    target="_blank"
                    style={{ color: `white` }}
                  >
                    <div className="Contact_icon_heading">Email</div>
                    <div className="Contact_icon_text">
                      abhishekgoyal3669@gmail.com
                    </div>
                  </a>
                </div>
              </div>
              <div className="Contact_icon_block">
                <div className="Contact_icon">
                  <img className="web_res_icon" src={Phone} />{" "}
                  <img className="mobile_res_icon" src={MobilePhone} />
                </div>
                <div>
                  <a
                    href="tel:+91 8952863669"
                    target="_blank"
                    style={{ color: `white` }}
                  >
                    <div className="Contact_icon_heading">Phone No.</div>
                    <div className="Contact_icon_text">8952863669</div>
                  </a>
                </div>
              </div>
            </div>
