          ...
          >
            <div className="col-lg-10 col-md-12">
              ...
              <div className="Footer_text">
                Have a website project to create, a job opportunity, or simply
                want to chat about web development? I'm just a message away.
                Feel free to reach out for Project Collaboration, Hire me for
                Your Projects, Consultation on ReactJS development, or whether
                you just want to connect for a friendly chat.
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-lg-3 col-md-4 col-sm-5">
                  <div className="fotter_icon_block">
                    ...
                    <div className="fotter_icon">
                      <a href="https://github.com/abbygoyal" target="_blank">
                        <img
            ...
            <div className="col-sm-6 col-8" style={{ paddingLeft: "0" }}>
              <div className="fotter_devloper_name">
                Nurtured with Devotion by <span> Abhishek Goyal </span>
              </div>
            </div>
          </div>
        </div>
