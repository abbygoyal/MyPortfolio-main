...
import ProfileImagee from "../../../assets/LandingPage/abby.png";
          ...
          <div className="row" style={{ height: "100%", alignItems: "center" }}>
            <div className="col-lg-6 col-md-7 col-sm-7">
              <div className="banner_content_block">
                <div className="banner_heading">
                  Hi, <span className="banner_heading_italic"> There! I’m</span>
                  <br />{" "}
                  <span className="banner_subheading">ABHISHEK GOYAL</span>
                </div>
            ...
            >
              <div className="user_profile_block">
                <div>
                  <div className="banner_dote1">
                    <img src={whiteDote} />
                  </div>
                  <div className="banner_Path2">
                    <img src={Path2} />
                  </div>
                  <div className="banner_Path3">
                    <img src={Path3} />
                  </div>
                  <img src={ProfileImagee} />
                  <div className="pic_background_line"></div>
                  <div className="banner_dote2">
                    <img src={blackDote} />
                  </div>
                  <div className="banner_Path1">
                    <img src={Path1} />
                  </div>
                </div>
              </div>
